...
namespace App\Livewire\Warga\Keluargas;
...
class Keluarga extends Component
{
    ...
    {
        $id = KeluargaAnggota::where('user_id', auth()->user()->id)->pluck('keluarga_id');
        $id = $id[0];
        // dd($id);
        ...
        $this->keluarga_details = KeluargaModel::find($id);
        $this->loadEdit($id);
    }
    ...
    public function save()
    {
        ...
        KeluargaModel::find($this->keluarga_details->id)->update([
        ...
        return redirect()->to(route('warga_keluarga.index'));
    ...
    public function render()
    {
        ...
        return view('livewire.warga.keluargas.keluarga', compact('kabupatenKotas', 'kecamatans', 'desaKelurahans'));
