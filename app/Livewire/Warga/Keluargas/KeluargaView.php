...
#[Title('View Keluarga | Sidaman')]

class KeluargaView extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.warga.keluargas.keluarga-view', compact('kabupatenKotas', 'kecamatans', 'desaKelurahans'));
