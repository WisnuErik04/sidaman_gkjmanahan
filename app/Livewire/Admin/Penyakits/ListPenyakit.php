...
#[Title('Data Penyakit | Sidaman')]
class ListPenyakit extends Component
{
    ...
    public function deleteConfirmed(): void
    {
        if ($this->idToDelete) {
            try {
                Penyakit::findOrFail($this->idToDelete)->delete();
    ...
    {
        $penyakits = $this->loadPenyakits();
        return view('livewire.admin.penyakits.list-penyakit', compact('penyakits'));
    }

    public function loadPenyakits()
    {
