...
#[Title('Data Tempat Babtis | Sidaman')]
class ListTempatBabtis extends Component
{
    ...
    public function deleteConfirmed(): void
    {
        if ($this->idToDelete) {
            try {
                TempatBabtis::findOrFail($this->idToDelete)->delete();
    ...
    {
        $tempat_babtises = $this->loadTempatBabtises();
        return view('livewire.admin.tempat-babtises.list-tempat-babtis', compact('tempat_babtises'));
    }

    public function loadTempatBabtises()
    {
        $query = TempatBabtis::query();
    
        // Filter nama tempat_babtis
        if ($this->searchName) {
