...
#[Title('Data Hobi | Sidaman')]
class ListHobi extends Component
{
    ...
    public function deleteConfirmed(): void
    {
        if ($this->idToDelete) {
            try {
                Hobi::findOrFail($this->idToDelete)->delete();
    ...
    {
        $hobis = $this->loadHobis();
        return view('livewire.admin.hobis.list-hobi', compact('hobis'));
    }

    public function loadHobis()
    {
        $query = Hobi::query();
