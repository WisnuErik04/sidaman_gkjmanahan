...
#[Title('Data Pendapatan | Sidaman')]
class ListPendapatan extends Component
{
    ...
    public function deleteConfirmed(): void
    {
        if ($this->idToDelete) {
            try {
                Pendapatan::findOrFail($this->idToDelete)->delete();
    ...
    {
        $pendapatans = $this->loadPendapatans();
        return view('livewire.admin.pendapatans.list-pendapatan', compact('pendapatans'));
    }

    public function loadPendapatans()
    {
        $query = Pendapatan::query();
    
        // Filter nama pendapatan
        if ($this->searchName) {
