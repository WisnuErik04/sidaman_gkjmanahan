...
#[Title('Data Hubungan Keluarga | Sidaman')]
class ListHubunganKeluarga extends Component
{
    ...
    public function deleteConfirmed(): void
    {
        if ($this->idToDelete) {
            try {
                HubunganKeluarga::findOrFail($this->idToDelete)->delete();
    ...
    {
        $hubungan_keluargas = $this->loadHubunganKeluargas();
        return view('livewire.admin.hubungan-keluargas.list-hubungan-keluarga', compact('hubungan_keluargas'));
    }

    public function loadHubunganKeluargas()
    {
        $query = HubunganKeluarga::query();
    
        // Filter nama hubungan_keluarga
        if ($this->searchName) {
