...
<div name="filter" class="max-w-96 sm:max-w-259">
    ...
    <!-- Segmented Tabs -->
    <div x-data="{ tab: 'utama', jenisStatus: @entangle('searchJenisStatus') }" class="mt-5 w-full ">
        <div class="flex p-1 rounded-lg bg-zinc-800/5 dark:bg-white/10 h-10">
            <template x-for="t in ['utama', 'detail', 'lainnya']" :key="t">
                <button @click="tab = t"
                    class="flex flex-1 justify-center items-center gap-2 rounded-md text-sm font-medium px-4 transition"
                    :class="tab === t ?
                        'shadow-xs text-zinc-800 dark:text-white bg-white dark:bg-white/20' :
        ...
        <div class="mt-4 space-y-6">
            ...
            <div x-show="tab === 'utama'" class="">
                <div class="mt-8 mb-4 sm:mb-8 grid grid-cols-1 sm:grid-cols-4 gap-4 lg:gap-6">

                    <div class="">
                        <label for="hs-feedback-post-comment-name-1"
                            class="block mb-2 text-sm font-medium dark:text-white">Nama
                            Anggota</label>
                        <input type="text"
                    ...
                    <div class="">
                        <label for="hs-feedback-post-comment-name-1"
                            class="block mb-2 text-sm font-medium dark:text-white">Blok
                            / Pepanthan</label>
                        <select multiple="" wire:model="searchBlok"
                            data-hs-select='{        
                                                        "hasSearch": true,
            ...
            <div x-show="tab === 'detail'" class="">
                <div class="mt-8 mb-4 sm:mb-8 grid grid-cols-1 sm:grid-cols-4 gap-4 lg:gap-6">
                    ...
                    <div class="">
                        ...
                        <div
                            class="w-full hs-dropdown [--auto-close:inside] [--placement:bottom-right] relative sm:inline-flex z-20">
                            ...
                            <div class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden bg-white border border-gray-200 shadow-md rounded-lg p-2 mt-2 dark:bg-neutral-900 dark:border dark:border-neutral-700"
                                ...
                                <div class="max-w-sm w-full flex gap-x-2">
                                    ...
                                    <input type="date" wire:model="searchTgl_lahir_akhir"
                    ...
                    <div class="">
                        <label for="hs-feedback-post-comment-name-1"
                            class="block mb-2 text-sm font-medium dark:text-white">Gol.
                            Darah</label>
                    ...
                    <div class="">
                        ...
                        <div
                            class="w-full hs-dropdown [--auto-close:inside] [--placement:bottom-right] relative sm:inline-flex z-20">
                            <button id="hs-dropdown-filter" type="button"
                                class="cursor-pointer hs-dropdown-toggle w-full py-2 px-3 inline-flex items-center gap-x-2 text-sm rounded-lg border border-gray-200 bg-gray-50 text-gray-800 shadow-2xs hover:bg-gray-50 focus:outline-hidden focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-400 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">
                                {{-- <button id="hs-dropdown-filter" type="button" class="hs-dropdown-toggle py-2 px-3 inline-flex items-center gap-x-2 text-sm rounded-lg border border-gray-200 bg-gray-50 text-gray-800 shadow-2xs hover:bg-gray-50 focus:outline-hidden focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-white dark:hover:bg-neutral-800 dark:focus:bg-neutral-800"> --}}
                                Rentang Tanggal
                                <div class="absolute top-1/2 end-3 -translate-y-1/2">
                                    <svg class="hs-dropdown-open:rotate-180 size-2.5 " width="16" height="16"
                            ...
                            <div class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden bg-white border border-gray-200 shadow-md rounded-lg p-2 mt-2 dark:bg-neutral-900 dark:border dark:border-neutral-700"
                                aria-labelledby="hs-dropdown-filter">
                                <div class="max-w-sm w-full flex gap-x-2">
                                    <input type="date" wire:model="searchTgl_babtis_awal"
                    ...
                    <div class="">
                        <label for="hs-feedback-post-comment-name-1"
                            class="block mb-2 text-sm font-medium dark:text-white">Tempat Babtis Dewasa /
                            Sidi</label>
                    ...
                    <div class="">
                        <label for="hs-feedback-post-comment-name-1"
                            class="block mb-2 text-sm font-medium dark:text-white">Tanggal Babtis Dewasa /
                            Sidi</label>
                        <div
                            class="w-full hs-dropdown [--auto-close:inside] [--placement:bottom-right] relative sm:inline-flex z-20">
                            <button id="hs-dropdown-filter" type="button"
                            ...
                            <div class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden bg-white border border-gray-200 shadow-md rounded-lg p-2 mt-2 dark:bg-neutral-900 dark:border dark:border-neutral-700"
                                aria-labelledby="hs-dropdown-filter">
                                <div class="max-w-sm w-full flex gap-x-2">
                                    <input type="date" wire:model="searchTgl_sidi_awal"
                                        id="hs-input-number-min-age"
                                        class="py-1 px-2.5 block w-40 border-gray-200 rounded-md sm:text-[13px] bg-gray-50 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
                                        placeholder="Min age" style="-moz-appearance: textfield;">
                    ...
                    <div class="">
                        <label for="hs-feedback-post-comment-name-1"
                            class="block mb-2 text-sm font-medium dark:text-white">Jenis Kelamin</label>
                        <select multiple="" wire:model="searchJenisKelamin"
                            data-hs-select='{        
                                                        "hasSearch": true,
                                                        "isSearchDirectMatch": false,
                                                        "searchPlaceholder": "Search...",
            ...
            <div x-show="tab === 'lainnya'" class="text-gray-600 dark:text-gray-300">
                <div class="mt-8 mb-4 sm:mb-8 grid grid-cols-1 sm:grid-cols-4 gap-4 lg:gap-6">

                    <div class="">
                        <label for="hs-feedback-post-comment-name-1"
                            class="block mb-2 text-sm font-medium dark:text-white">Tanggal Ulang Tahun</label>
                        <div
                            class="w-full hs-dropdown [--auto-close:inside] [--placement:bottom-right] relative sm:inline-flex z-20">
                            <button id="hs-dropdown-filter" type="button"
                                class="cursor-pointer hs-dropdown-toggle py-2 w-full px-3 inline-flex items-center gap-x-2 text-sm rounded-lg border border-gray-200 bg-gray-50 text-gray-800 shadow-2xs hover:bg-gray-50 focus:outline-hidden focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-400 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">
                            ...
                            <div class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden bg-white border border-gray-200 shadow-md rounded-lg p-2 mt-2 dark:bg-neutral-900 dark:border dark:border-neutral-700"
                                aria-labelledby="hs-dropdown-filter">
                                <div class="max-w-sm w-full flex gap-x-2">
                                    <input type="date" wire:model="searchTgl_ulang_tahun_awal"
                                        id="hs-input-number-min-age"
                                        class="py-1 px-2.5 block w-40 border-gray-200 rounded-md sm:text-[13px] bg-gray-50 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
                                        placeholder="Min age" style="-moz-appearance: textfield;">
                                    <input type="date" wire:model="searchTgl_ulang_tahun_akhir"
                                        id="hs-input-number-max-age"
                                        class="py-1 px-2.5 block w-40 border-gray-200 rounded-md sm:text-[13px] bg-gray-50 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
                                        placeholder="Max age" style="-moz-appearance: textfield;">
                                </div>
                    ...
                    <div class="">
                        ...
                        <select multiple="" wire:model="searchGenerasi"
                            ...
                            class="hidden">
                            {{-- <option value=""></option> --}}
                            @foreach ($generasis as $generasi)
                                <option value="{{ $generasi->id }}">{{ $generasi->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="">
                        <label for="hs-feedback-post-comment-name-1"
                            class="block mb-2 text-sm font-medium dark:text-white">Kelompok Usia</label>
                        <select multiple="" wire:model="searchKelompokUsia"
                            data-hs-select='{        
                                                        "hasSearch": true,
                                                        "isSearchDirectMatch": false,
                                                        "searchPlaceholder": "Search...",
                            ...
                            class="hidden">
                            {{-- <option value=""></option> --}}
                            @foreach ($kelompokUsias as $kelompokUsia)
                                <option value="{{ $kelompokUsia->id }}">{{ $kelompokUsia->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="">
                        <label for="hs-feedback-post-comment-name-1"
                            class="block mb-2 text-sm font-medium dark:text-white">Jenis Status</label>
                        <select x-model="jenisStatus"
                            data-hs-select='{        
                                                        "hasSearch": true,
                                                        "isSearchDirectMatch": false,
                                                        "searchPlaceholder": "Search...",
                            ...
                            <option value="2">Riwayat Status</option>
                        </select>
                    </div>

                    <div class="" x-show="jenisStatus == '1'" x-cloak>
                        <label for="hs-feedback-post-comment-name-1"
                            class="block mb-2 text-sm font-medium dark:text-white">Status</label>
                        <select multiple="" wire:model="searchStatus"
                            data-hs-select='{        
                                                        "hasSearch": true,
                                                        "isSearchDirectMatch": false,
                                                        "searchPlaceholder": "Search...",
                        ...
                        <span class="text-xs text-gray-500 dark:text-neutral-400">*Status terakhir yang pernah diubah</span>
                    </div>

                    <div class="" x-show="jenisStatus == '2'" x-cloak>
                        <label for="hs-feedback-post-comment-name-1"
                            class="block mb-2 text-sm font-medium dark:text-white">Riwayat Status</label>
                        <select wire:model="searchRiwayatStatus"
                            data-hs-select='{        
                                                        "hasSearch": true,
                                                        "isSearchDirectMatch": false,
                                                        "searchPlaceholder": "Search...",
                        ...
                        <span class="text-xs text-gray-500 dark:text-neutral-400">*Pencarian warga gereja yang memiliki riwayat status tertentu</span>
                    </div>

                    <div class="" x-show="jenisStatus == '2'" x-cloak>
                        <label for="hs-feedback-post-comment-name-1"
                            class="block mb-2 text-sm font-medium dark:text-white">Tanggal Riwayat Status</label>
                        <div
                            class="w-full hs-dropdown [--auto-close:inside] [--placement:bottom-right] relative sm:inline-flex z-20">
                            <button id="hs-dropdown-filter" type="button"
                                class="cursor-pointer hs-dropdown-toggle py-2 w-full px-3 inline-flex items-center gap-x-2 text-sm rounded-lg border border-gray-200 bg-gray-50 text-gray-800 shadow-2xs hover:bg-gray-50 focus:outline-hidden focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-400 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">
                            ...
                            <div class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden bg-white border border-gray-200 shadow-md rounded-lg p-2 mt-2 dark:bg-neutral-900 dark:border dark:border-neutral-700"
                                aria-labelledby="hs-dropdown-filter">
                                <div class="max-w-sm w-full flex gap-x-2">
                                    <input type="date" wire:model="search_riwayat_status_awal" id="hs-input-number-min-age"
                                        class="py-1 px-2.5 block w-40 border-gray-200 rounded-md sm:text-[13px] bg-gray-50 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
                                        placeholder="Min age" style="-moz-appearance: textfield;">
                                    <input type="date" wire:model="search_riwayat_status_akhir"
                                        id="hs-input-number-max-age"
                                        class="py-1 px-2.5 block w-40 border-gray-200 rounded-md sm:text-[13px] bg-gray-50 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
                                        placeholder="Max age" style="-moz-appearance: textfield;">
                                </div>
