<form wire:submit="saveAnggota">
    <div class="mb-4 grid grid-cols-1 sm:grid-cols-4 gap-4 lg:gap-6">
        <div>
        ...
        <div>
            <label for="hs-feedback-post-comment-name-1"
                class="block mb-2 text-sm font-medium dark:text-white">Tanggal baptis dewasa/ Sidi <span class="text-red-500">*</span></label>
            <input type="date"
                class="py-2.5 sm:py-3 px-4 block w-full border border-gray-200 rounded-lg sm:text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
        ...
        <div>
            <label for="hs-feedback-post-comment-name-1"
                class="block mb-2 text-sm font-medium dark:text-white">Aktivitas pelayanan yg aktif diikuti <span class="text-red-500">*</span></label>
            <input type="text"
                class="py-2.5 sm:py-3 px-4 block w-full border border-gray-200 rounded-lg sm:text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
        ...
        <div>
            <label for="hs-feedback-post-comment-name-1"
                class="block mb-2 text-sm font-medium dark:text-white">Memiliki bpjs atau asuransi lainnya <span class="text-red-500">*</span></label>
            <div class="grid sm:grid-cols-2 gap-2">
        ...
        <div>
            <label for="hs-feedback-post-comment-name-1"
                class="block mb-2 text-sm font-medium dark:text-white">Domisili di alamat ini <span class="text-red-500">*</span></label>
            <div class="grid sm:grid-cols-2 gap-2">
